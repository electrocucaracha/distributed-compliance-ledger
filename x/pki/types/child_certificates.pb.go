...
type ChildCertificates struct {
	...
	SubjectKeyId   string `protobuf:"bytes,4,opt,name=subject_key_id,json=subjectKeyId,proto3" json:"subject_key_id,omitempty"`
}
...
func (m *ChildCertificates) GetSubject() string {
	if m != nil {
		return m.Subject
	}
	return ""
...
func (m *ChildCertificates) GetSubjectKeyId() string {
	if m != nil {
...
var fileDescriptor_1f81991ee339011f = []byte{
	...
	,
}
...
func (m *ChildCertificates) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SubjectKeyId) > 0 {
		...
		i = encodeVarintChildCertificates(dAtA, i, uint64(len(m.SubjectKeyId)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Subject) > 0 {
		...
		i = encodeVarintChildCertificates(dAtA, i, uint64(len(m.Subject)))
		i--
		dAtA[i] = 0x1a
	}
